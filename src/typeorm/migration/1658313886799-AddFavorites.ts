...
export class AddFavorites1658313886799 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "favorites" ("userId" integer NOT NULL, CONSTRAINT "PK_e747534006c6e3c2f09939da60f" PRIMARY KEY ("userId"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "favorites_artists_artist" ("favoritesUserId" integer NOT NULL, "artistId" uuid NOT NULL, CONSTRAINT "PK_4c6c39b4ed2ec136e52b84e1a3f" PRIMARY KEY ("favoritesUserId", "artistId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_95f4000481a979a54ba567ce39" ON "favorites_artists_artist" ("favoritesUserId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_2a44f2a39bd14c72dfd8ad7933" ON "favorites_artists_artist" ("artistId") `,
    );
    await queryRunner.query(
      `CREATE TABLE "favorites_albums_album" ("favoritesUserId" integer NOT NULL, "albumId" uuid NOT NULL, CONSTRAINT "PK_fe6912b554db33d2ede76cb0d2e" PRIMARY KEY ("favoritesUserId", "albumId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_74661bbbc992e24cfe2e37d47f" ON "favorites_albums_album" ("favoritesUserId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_4ff0c3cde93d2bc8c23c2b72c3" ON "favorites_albums_album" ("albumId") `,
    );
    await queryRunner.query(
      `CREATE TABLE "favorites_tracks_track" ("favoritesUserId" integer NOT NULL, "trackId" uuid NOT NULL, CONSTRAINT "PK_73259d7fa43bf08b297fe83dc26" PRIMARY KEY ("favoritesUserId", "trackId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_9a5ea9fa77fea918cdad3a0fda" ON "favorites_tracks_track" ("favoritesUserId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "favorites_artists_artist" ADD CONSTRAINT "FK_95f4000481a979a54ba567ce391" FOREIGN KEY ("favoritesUserId") REFERENCES "favorites"("userId") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "favorites_albums_album" ADD CONSTRAINT "FK_74661bbbc992e24cfe2e37d47fc" FOREIGN KEY ("favoritesUserId") REFERENCES "favorites"("userId") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "favorites_tracks_track" ADD CONSTRAINT "FK_9a5ea9fa77fea918cdad3a0fda8" FOREIGN KEY ("favoritesUserId") REFERENCES "favorites"("userId") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "favorites_tracks_track" DROP CONSTRAINT "FK_9a5ea9fa77fea918cdad3a0fda8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "favorites_albums_album" DROP CONSTRAINT "FK_4ff0c3cde93d2bc8c23c2b72c3f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "favorites_albums_album" DROP CONSTRAINT "FK_74661bbbc992e24cfe2e37d47fc"`,
    );
    await queryRunner.query(
      `ALTER TABLE "favorites_artists_artist" DROP CONSTRAINT "FK_2a44f2a39bd14c72dfd8ad7933b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "favorites_artists_artist" DROP CONSTRAINT "FK_95f4000481a979a54ba567ce391"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_9a5ea9fa77fea918cdad3a0fda"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_74661bbbc992e24cfe2e37d47f"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_95f4000481a979a54ba567ce39"`,
    );
